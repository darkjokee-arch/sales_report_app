...
KAPT_BJDCE = {
    ...
    # 부산 26***
    "부산시 중구":"26110","부산시 서구":"26140","부산시 동구":"26170","영도구":"26200",
    "부산진구":"26230","동래구":"26260","부산시 남구":"26290","부산시 북구":"26320",
    ...
    "무주군":"52730","장수군":"52740","임실군":"52750","순창군":"52770","고창군":"52790","부안군":"52800",
    # 전남 46***
    ...
    "진도군":"46900","신안군":"46910",
    # 경북 47***
    "포항시 남구":"47111","포항시 북구":"47113","경주시":"47130","김천시":"47150","안동시":"47170",
    "구미시":"47190","영주시":"47210","영천시":"47230","상주시":"47250","문경시":"47280",
    "경산시":"47290","의성군":"47730","청송군":"47750","영양군":"47760","영덕군":"47770",
    ...
    "남해군":"48820","하동군":"48830","산청군":"48840","함양군":"48850","거창군":"48860","합천군":"48870",
    # 제주 50***
...
_KAPT_BJDCE_SORTED = sorted(KAPT_BJDCE.items(), key=lambda x: -len(x[0]))


def _resolve_kapt_code(address: str, complex_name: str) -> str:
    bjdce = "11650"
    for k, v in _KAPT_BJDCE_SORTED:
        if k in address:
            bjdce = v
            break
    try:
